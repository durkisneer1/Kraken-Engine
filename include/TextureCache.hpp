...
public:
     ...
     * @return The texture pointer.
     */
    [[maybe_unused]] std::shared_ptr<Texture> create(const std::string &name, const math::Vec2 &size, SDL_Color color);
     ...
     * @return The texture pointer.
     */
    [[maybe_unused]] std::shared_ptr<Texture> move(const std::string &name, std::shared_ptr<Texture> texture);
